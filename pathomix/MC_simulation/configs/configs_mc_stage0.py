...
auc_lower_bound = 0.6
auc_upper_bound = 0.9
num_generate_train_distributions = 10 # how many training/true distributions will be created
...
sens_search = [1.0, 0.995, 0.99, 0.98, 0.97, 0.96, 0.95, 0.94, 0.93, 0.92, 0.91, 0.9, 0.85, 0.8, 0.75, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1, 0.05, 0.01]

# now prepare configs for testing (draw randomly from the training/true distibution)
prevalences = [0.01, 0.03, 0.05, 0.1, 0.15, 0.2, 0.5] # biomarker specific
...
out_file ='/home/ubuntu/bucket/pathomix/results/simulations/stage0_v2.csv'