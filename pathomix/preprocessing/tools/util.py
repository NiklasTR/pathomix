...
def display_img(np_img, text=None, font_path="/home/pmf/Documents/DataMining/test_read_tcga_slide/python-wsi-preprocessing/docs/arial.ttf", size=48, color=(255, 0, 0),
